...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //全局防止多点触控
    if ([UIView conformsToProtocol:@protocol(UIAppearance)] &&
        [UIView conformsToProtocol:@protocol(UIAppearanceContainer)]) {
        //设置唯一响应
...
//    JLRoutes * routes =  [JLRoutes routesForScheme:@"zmtpled"];
...
//    }];
    ...
    [ZMRouterTools initRouterWithPlistName:@"ZMRouter" withScheme:@"zmtpled"];
