...
@implementation XESNetworkUtils
...
+ (NSStringEncoding)stringEncodingWithRequest:(XESNetworkBaseRequest *)request {
    ...
    if (request.requestTask.response.textEncodingName) {
        CFStringEncoding encoding = CFStringConvertIANACharSetNameToEncoding((CFStringRef)request.requestTask.response.textEncodingName);
...
@implementation XESNetworkPrivate
